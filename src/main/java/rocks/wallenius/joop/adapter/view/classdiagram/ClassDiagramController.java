...
import rocks.wallenius.joop.adapter.view.classdiagram.dialog.NewObject;
import rocks.wallenius.joop.adapter.view.classdiagram.dialog.NewObjectDialog;
...
public class ClassDiagramController implements Initializable {
    ...
    public void updateView(List<Class> classes) {
        clear();
        addClasses(classes);
    }
