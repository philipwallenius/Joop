...
public class EditorController implements Initializable {
    ...
    public void open(Source source) {
        rocks.wallenius.joop.adapter.view.editor.Tab newTab = new rocks.wallenius.joop.adapter.view.editor.Tab(source);
    ...
    public void close(Source source) {
        ...
        for(javafx.scene.control.Tab tab : tabPane.getTabs()) {
            if(tab.getText().equals(source.getClassName()) && tab instanceof rocks.wallenius.joop.adapter.view.editor.Tab) {
                tabToBeClosed = tab;
            }
        }
    ...
    public Source getActiveSource() {
        rocks.wallenius.joop.adapter.view.editor.Tab activeTab = (rocks.wallenius.joop.adapter.view.editor.Tab) tabPane.getSelectionModel().getSelectedItem();
        return activeTab.getSource();
    }

    public List<Source> getAllSources() {
        List<Source> sources = new ArrayList<>(tabPane.getTabs().size());
        tabPane.getTabs().forEach(tab -> sources.add(((rocks.wallenius.joop.adapter.view.editor.Tab)tab).getSource()));
        return sources;
    }
    ...
    private void setupUiBindings() {
        ...
        tabPane.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
            if (newValue != null) {
                if( newValue instanceof rocks.wallenius.joop.adapter.view.editor.Tab) {
                    rocks.wallenius.joop.adapter.view.editor.Tab selectedTab = (rocks.wallenius.joop.adapter.view.editor.Tab) newValue;
