package rocks.wallenius.joop.gui.tabs;
...
public class TabsController implements Initializable {
    ...
    public boolean isUnsavedChanges() {
        ...
        for(javafx.scene.control.Tab tab : getTabs()) {
            if(tab instanceof rocks.wallenius.joop.model.entity.Tab) {
                rocks.wallenius.joop.model.entity.Tab currentTab = (rocks.wallenius.joop.model.entity.Tab) tab;
    ...
    private void setSyntaxHighlightingForTab(rocks.wallenius.joop.model.entity.Tab tab) {
    ...
    private void setupUiBindings() {
        ...
        tabPane.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
            if (newValue != null) {
                rocks.wallenius.joop.model.entity.Tab currentTab = getTabByName(newValue.getText());
    ...
    private rocks.wallenius.joop.model.entity.Tab getTabByName(String name) {
        for(javafx.scene.control.Tab tab : getTabs()) {
            if(tab.getText().equals(name) && tab instanceof rocks.wallenius.joop.model.entity.Tab) {
                return (rocks.wallenius.joop.model.entity.Tab) tab;
            }
        }
        return null;
    }
